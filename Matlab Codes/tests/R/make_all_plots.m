...
% QSC nominal
h(end+1) = plot(R(QSC_idx), Tall_QSC.MSE_nom_val(QSC_idx), '-o', 'LineWidth', 2);
vals(end+1) = max(Tall_QSC.MSE_nom_val(QSC_idx));
...
% LQR nominal
h(end+1) = plot(R(LQR_idx), Tall_LQR.MSE_nom_val(LQR_idx), '--o', 'LineWidth', 2);
vals(end+1) = max(Tall_LQR.MSE_nom_val(LQR_idx));
...
ax1.Legend.Title.String = 'Trajectory MSE vs State Perturbation';
ax1.Legend.Title.FontSize = Font_Size;

xlabel('State Sampling Radius r [m]', ...
...
savefig('trajectory_mse_vs_radius.fig');
print('-dpng', '-painters', 'trajectory_mse_vs_radius.png');
print('-depsc2', '-painters', 'trajectory_mse_vs_radius.eps');
%% ============================================================
...
savefig('ss_error_vs_radius.fig');
print('-dpng', '-painters', 'ss_error_vs_radius.png');
print('-depsc2', '-painters', 'ss_error_vs_radius.eps');
%% ============================================================
...
ax1.Legend.Title.String = 'Solver Time vs State Perturbation';
ax1.Legend.Title.FontSize = Font_Size;
...
savefig('time_vs_radius.fig');
print('-dpng', '-painters', 'time_vs_radius.png');
print('-depsc2', '-painters', 'time_vs_radius.eps');
